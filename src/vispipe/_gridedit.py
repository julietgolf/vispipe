...
def tri_bbox_prep(mesh: np.ndarray,
    ...
    """Frontend for gridedit.trigridtrim() that widens the bbox so the data extends past the edge of the plot.
    ...
    Returns
    -------
    `trimmedmesh` | `trimmedmesh`, `trimmedvals` : np.ndarray | tuple[np.ndarray,np.ndarray]
