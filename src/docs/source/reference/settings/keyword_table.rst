...
|                     | - V: If passed instead of a dict in the plot section of a config the global and universal settings are used. Using the json keyword ``null`` is preferred. |         |
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
...
|                     | #. ``"[modules,...].func"``                                                                                                                                |         |
|                     |                                                                                                                                                            |         |
|                     | ``"mesh"`` in this context is a `bool` and determines whether a mesh is passed or not.                                                                     |         |
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
...
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
| ``"sig"``           | Sub-dictionary of ``"plotter"`` dictionary. Describes the function signature of the plotting function what reader outputs and vispipe variables to use.    |         |
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
...
|                     |                                                                                                                                                            |         |
|                     | - F: A `bool` that determines if a plotter requires a mesh to plot against.                                                                                |         |
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
...
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
| ``"deflist"``       | - O: ``list[str]`` that define a default set of datatypes in an OPT file.                                                                                  |         |
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
| ``"file_records"``  | - U: ``dict`` where individual records have default settings defined for datatypes with multiple records.                                                  |         |
+---------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+
| ``"recs"``          | Used to define record specific settings. Can be a single ``str`` or a ``list[str]`` to filter previously defined record settings or ``dict[dict]`` to      |         |
